...
const SearchBar = ({ setResults }) => {
  ...
  const fetchAllItems = async () => {
    setIsLoading(true);
    setError("");
    const foundItemsRef = collection(db, "lostItems");
  ...
  return (
    ...
    <div className="search-bar-container">
      <h2 className="search-title">신고된 분실물을 검색해보세요.</h2>
      <div className="search-bar">
        ...
        <div className="search-filters">
          <div className="filter-group">
            <label htmlFor="found-type" className="filter-label">분실물 종류</label>
            <select
              id="found-type"
              value={type}
          ...
          <div className="filter-group">
            <label htmlFor="found-location" className="filter-label">분실한 장소</label>
            <select
              id="found-location"
              value={location}
